...
void juego::nombres()
{
        ...
        categorias[6]="Sports";categorias[7]="All";
...
void juego::nom_juego()
{
    ...
    nombre_juegos[10]="Red Dead Redemption 2";  nombre_juegos[11]="Assassins Creed Origins";
    ...
    nombre_juegos[18]="Marvel VS Capcom";       nombre_juegos[19]="Tekken 7";
    nombre_juegos[20]="Mortal Kombat XL";       nombre_juegos[21]="Killer Instinct";
    nombre_juegos[22]="NARUTO SHIPPUDE";        nombre_juegos[23]="Warhammer Vermintide 2";
    ...
    nombre_juegos[30]="Kingdom Hearts 3";       nombre_juegos[31]="Fallout 76";
    ...
    nombre_juegos[38]="Diablo 3";               nombre_juegos[39]="";
